...
class HXCPP_CLASS_ATTRIBUTES GenericStack_hscript_Token_obj : public hx::Object
{
	...
	public:
		...
		inline  ::haxe::ds::GenericCell_hscript_Token _hx_set_head(hx::StackContext *_hx_ctx, ::haxe::ds::GenericCell_hscript_Token _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return head=_hx_v; }
