...
#include <hxinc/cpp/FastIterator.h>
#endif
...
class HXCPP_CLASS_ATTRIBUTES GenericStackIterator_hscript_Token_obj : public ::cpp::FastIterator_obj<  ::hscript::Token >
{
	...
	public:
		...
		inline  ::haxe::ds::GenericCell_hscript_Token _hx_set_current(hx::StackContext *_hx_ctx, ::haxe::ds::GenericCell_hscript_Token _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return current=_hx_v; }
		bool hasNext();
