...
class HXCPP_CLASS_ATTRIBUTES GenericCell_hscript_Token_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("GenericCell_hscript_Token",07,90,f7,86); }
		 ...
		 ::hscript::Token elt;
		inline  ::hscript::Token _hx_set_elt(hx::StackContext *_hx_ctx, ::hscript::Token _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return elt=_hx_v; }
		 ::haxe::ds::GenericCell_hscript_Token next;
		inline  ::haxe::ds::GenericCell_hscript_Token _hx_set_next(hx::StackContext *_hx_ctx, ::haxe::ds::GenericCell_hscript_Token _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
};
