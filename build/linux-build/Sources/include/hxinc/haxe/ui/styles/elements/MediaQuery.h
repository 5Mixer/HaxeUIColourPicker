...
class HXCPP_CLASS_ATTRIBUTES MediaQuery_obj : public hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__directives(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _directives=_hx_v; }
		 ::haxe::ui::styles::StyleSheet _styleSheet;
		inline  ::haxe::ui::styles::StyleSheet _hx_set__styleSheet(hx::StackContext *_hx_ctx, ::haxe::ui::styles::StyleSheet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _styleSheet=_hx_v; }
		...
		inline  ::haxe::ui::styles::StyleSheet _hx_set_styleSheet(hx::StackContext *_hx_ctx, ::haxe::ui::styles::StyleSheet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return styleSheet=_hx_v; }
