...
class HXCPP_CLASS_ATTRIBUTES Directive_obj : public hx::Object
{
	...
	public:
		...
		::String directive;
		inline ::String _hx_set_directive(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return directive=_hx_v; }
		 ::haxe::ui::styles::Value value;
		inline  ::haxe::ui::styles::Value _hx_set_value(hx::StackContext *_hx_ctx, ::haxe::ui::styles::Value _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return value=_hx_v; }
		bool defective;
};
