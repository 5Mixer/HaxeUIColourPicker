...
class HXCPP_CLASS_ATTRIBUTES StyleSheet_obj : public hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__imports(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _imports=_hx_v; }
		::Array< ::Dynamic> _rules;
		inline ::Array< ::Dynamic> _hx_set__rules(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _rules=_hx_v; }
		::Array< ::Dynamic> _mediaQueries;
		inline ::Array< ::Dynamic> _hx_set__mediaQueries(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _mediaQueries=_hx_v; }
		...
		inline ::Array< ::Dynamic> _hx_set_imports(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return imports=_hx_v; }
		::Array< ::Dynamic> get_imports();
		::Dynamic get_imports_dyn();

		::Array< ::Dynamic> rules;
		inline ::Array< ::Dynamic> _hx_set_rules(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return rules=_hx_v; }
