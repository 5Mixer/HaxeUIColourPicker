...
class HXCPP_CLASS_ATTRIBUTES Selector_obj : public hx::Object
{
	...
	public:
		...
		::Array< ::Dynamic> parts;
		inline ::Array< ::Dynamic> _hx_set_parts(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parts=_hx_v; }
