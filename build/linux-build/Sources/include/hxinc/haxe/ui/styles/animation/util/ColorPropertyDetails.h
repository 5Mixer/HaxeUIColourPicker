...
{
            	HX_GC_STACKFRAME(&_hx_pos_44218ffaa5a81fdb_14_new)
HXLINE(  15)		( ( ::haxe::ui::styles::animation::util::ColorPropertyDetails)(__this) )->_hx_set_target(HX_CTX, target);
HXLINE(  16)		( ( ::haxe::ui::styles::animation::util::ColorPropertyDetails)(__this) )->_hx_set_propertyName(HX_CTX, propertyName);
