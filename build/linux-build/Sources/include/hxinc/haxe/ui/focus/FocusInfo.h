			...
			*(void **)__this = FocusInfo_obj::_hx_vtable;
{
		...
		inline  ::haxe::ui::core::Component _hx_set_view(hx::StackContext *_hx_ctx, ::haxe::ui::core::Component _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return view=_hx_v; }
		::Dynamic currentFocus;
		inline ::Dynamic _hx_set_currentFocus(hx::StackContext *_hx_ctx,::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return currentFocus=_hx_v; }
};
