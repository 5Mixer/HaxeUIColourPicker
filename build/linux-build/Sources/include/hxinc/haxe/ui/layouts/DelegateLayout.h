...
class HXCPP_CLASS_ATTRIBUTES DelegateLayout_obj : public  ::haxe::ui::layouts::DefaultLayout_obj
{
	...
	public:
		...
		inline  ::haxe::ui::layouts::DelegateLayoutSize _hx_set__size(hx::StackContext *_hx_ctx, ::haxe::ui::layouts::DelegateLayoutSize _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _size=_hx_v; }
