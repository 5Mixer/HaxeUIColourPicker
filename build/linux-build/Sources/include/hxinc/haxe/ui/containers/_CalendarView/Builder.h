...
class HXCPP_CLASS_ATTRIBUTES Builder_obj : public  ::haxe::ui::core::CompositeBuilder_obj
{
	...
	public:
		...
		inline  ::haxe::ui::containers::CalendarView _hx_set__calendarView(hx::StackContext *_hx_ctx, ::haxe::ui::containers::CalendarView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _calendarView=_hx_v; }
		void create();
