...
class HXCPP_CLASS_ATTRIBUTES Events_obj : public  ::haxe::ui::events::Events_obj
{
	...
	public:
		...
		inline  ::haxe::ui::components::Scroll _hx_set__scroll(hx::StackContext *_hx_ctx, ::haxe::ui::components::Scroll _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _scroll=_hx_v; }
		 ::haxe::ui::components::Button _deincButton;
		inline  ::haxe::ui::components::Button _hx_set__deincButton(hx::StackContext *_hx_ctx, ::haxe::ui::components::Button _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _deincButton=_hx_v; }
		 ::haxe::ui::components::Button _incButton;
		inline  ::haxe::ui::components::Button _hx_set__incButton(hx::StackContext *_hx_ctx, ::haxe::ui::components::Button _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _incButton=_hx_v; }
		 ::haxe::ui::components::Button _thumb;
		inline  ::haxe::ui::components::Button _hx_set__thumb(hx::StackContext *_hx_ctx, ::haxe::ui::components::Button _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _thumb=_hx_v; }
		void _hx_register();
		...
		inline  ::haxe::ui::geom::Point _hx_set__mouseDownOffset(hx::StackContext *_hx_ctx, ::haxe::ui::geom::Point _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _mouseDownOffset=_hx_v; }
