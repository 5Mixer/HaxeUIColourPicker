...
class HXCPP_CLASS_ATTRIBUTES Events_obj : public  ::haxe::ui::events::Events_obj
{
	...
	public:
		...
		inline  ::haxe::ui::components::Stepper _hx_set__stepper(hx::StackContext *_hx_ctx, ::haxe::ui::components::Stepper _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _stepper=_hx_v; }
		void _hx_register();
