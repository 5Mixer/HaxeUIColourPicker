...
class HXCPP_CLASS_ATTRIBUTES Timer_obj : public  ::haxe::ui::backend::TimerImpl_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="haxe.ui.util.Timer")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"haxe.ui.util.Timer"); }
		...
		inline static hx::ObjectPtr< Timer_obj > __alloc(hx::Ctx *_hx_ctx,int delay, ::Dynamic callback) {
			Timer_obj *__this = (Timer_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Timer_obj), false, "haxe.ui.util.Timer"));
