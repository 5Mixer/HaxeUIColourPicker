...
class HXCPP_CLASS_ATTRIBUTES ValidationManager_obj : public hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__queue(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _queue=_hx_v; }
		::Array< ::Dynamic> _displayQueue;
		inline ::Array< ::Dynamic> _hx_set__displayQueue(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _displayQueue=_hx_v; }
		 ::haxe::ui::util::EventMap _events;
		inline  ::haxe::ui::util::EventMap _hx_set__events(hx::StackContext *_hx_ctx, ::haxe::ui::util::EventMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _events=_hx_v; }
