...
class HXCPP_CLASS_ATTRIBUTES Behaviours_obj : public hx::Object
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set__registry(hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _registry=_hx_v; }
		 ::haxe::ds::StringMap _instances;
		inline  ::haxe::ds::StringMap _hx_set__instances(hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _instances=_hx_v; }
		...
		inline ::Array< ::String > _hx_set__updateOrder(hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _updateOrder=_hx_v; }
		...
		inline ::Array< ::String > _hx_set__actualUpdateOrder(hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _actualUpdateOrder=_hx_v; }
		::Array< ::String > actualUpdateOrder;
		inline ::Array< ::String > _hx_set_actualUpdateOrder(hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return actualUpdateOrder=_hx_v; }
