...
{
            	HX_GC_STACKFRAME(&_hx_pos_c2179f2e0a918c8b_8_new)
HXLINE(  22)		( ( ::haxe::ui::core::TextInputData)(__this) )->_hx_set_onChangedCallback(HX_CTX, null());
HXLINE(  21)		( ( ::haxe::ui::core::TextInputData)(__this) )->_hx_set_onScrollCallback(HX_CTX, null());
HXLINE(  19)		( ( ::haxe::ui::core::TextInputData)(__this) )->vscrollNativeWheel = false;
HXLINE(  18)		( ( ::haxe::ui::core::TextInputData)(__this) )->_hx_set_vscrollPageStep(HX_CTX, null());
...
HXLINE(   9)		( ( ::haxe::ui::core::TextInputData)(__this) )->password = false;
		...
		inline  ::Dynamic _hx_set_vscrollPageStep(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return vscrollPageStep=_hx_v; }
		bool vscrollNativeWheel;
		 ::Dynamic onScrollCallback;
		inline  ::Dynamic _hx_set_onScrollCallback(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onScrollCallback=_hx_v; }
		Dynamic onScrollCallback_dyn() { return onScrollCallback;}
		 ::Dynamic onChangedCallback;
		inline  ::Dynamic _hx_set_onChangedCallback(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onChangedCallback=_hx_v; }
