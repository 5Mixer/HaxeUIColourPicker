...
class HXCPP_CLASS_ATTRIBUTES ComponentBase_obj : public  ::haxe::ui::core::ComponentBounds_obj
{
	...
	public:
		...
		inline  ::haxe::ui::core::TextDisplay _hx_set__textDisplay(hx::StackContext *_hx_ctx, ::haxe::ui::core::TextDisplay _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _textDisplay=_hx_v; }
		...
		inline  ::haxe::ui::core::TextInput _hx_set__textInput(hx::StackContext *_hx_ctx, ::haxe::ui::core::TextInput _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _textInput=_hx_v; }
		...
		inline  ::haxe::ui::core::ImageDisplay _hx_set__imageDisplay(hx::StackContext *_hx_ctx, ::haxe::ui::core::ImageDisplay _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _imageDisplay=_hx_v; }
		...
		inline  ::haxe::ds::StringMap _hx_set__classProperties(hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _classProperties=_hx_v; }
		void setClassProperty(::String name,::String value);
		::Dynamic setClassProperty_dyn();

		 ::Dynamic _hasNativeEntry;
		inline  ::Dynamic _hx_set__hasNativeEntry(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hasNativeEntry=_hx_v; }
		bool hasNativeEntry;
		...
		::String _className;
		inline ::String _hx_set__className(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _className=_hx_v; }
		::String className;
		...
		inline ::String _hx_set__nativeClassName(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _nativeClassName=_hx_v; }
		::String nativeClassName;
		inline ::String _hx_set_nativeClassName(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return nativeClassName=_hx_v; }
