...
class HXCPP_CLASS_ATTRIBUTES MouseEvent_obj : public  ::haxe::ui::events::UIEvent_obj
{
	...
	public:
		...
		bool shiftKey;
		 ::Dynamic localX;
		inline  ::Dynamic _hx_set_localX(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return localX=_hx_v; }
		 ::Dynamic get_localX();
		::Dynamic get_localX_dyn();

		 ::Dynamic localY;
		inline  ::Dynamic _hx_set_localY(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return localY=_hx_v; }
		 ::Dynamic get_localY();
