...
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_50_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",50,0xa46a82af)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_158_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",158,0xa46a82af)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_222_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",222,0xa46a82af)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_288_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",288,0xa46a82af)
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_306_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",306,0xa46a82af)
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_331_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",331,0xa46a82af)
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_359_trim,"StringTools","trim",0x2908d066,"StringTools.trim","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",359,0xa46a82af)
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_375_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",375,0xa46a82af)
HX_LOCAL_STACK_FRAME(_hx_pos_0110c3293330012e_434_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","/home/mixer/tools/Kha/Tools/haxe/std/StringTools.hx",434,0xa46a82af)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_50_urlEncode)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_GC_STACKFRAME(&_hx_pos_0110c3293330012e_158_htmlEscape)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_222_startsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_288_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_306_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_331_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_359_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_0110c3293330012e_375_lpad)
...
HXLINE( 382)				buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(c)));
            			}
            			else {
...
HXLINE( 384)				buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(s)));
            			}
            			else {
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_0110c3293330012e_434_replace)
