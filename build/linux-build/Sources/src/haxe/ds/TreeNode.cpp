...
HX_DEFINE_STACK_FRAME(_hx_pos_a32a5524717ac37b_255_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",255,0x765a4266)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,hx::Null< int >  __o_h){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a32a5524717ac37b_255_new)
