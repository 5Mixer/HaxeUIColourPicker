...
HX_DEFINE_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_107_new,"haxe.ds.GenericStack_hscript_Token","new",0xda5f4ac8,"haxe.ds.GenericStack_hscript_Token.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",107,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_113_add,"haxe.ds.GenericStack_hscript_Token","add",0xda556c89,"haxe.ds.GenericStack_hscript_Token.add","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",113,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_122_first,"haxe.ds.GenericStack_hscript_Token","first",0x104a5c98,"haxe.ds.GenericStack_hscript_Token.first","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",122,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_130_pop,"haxe.ds.GenericStack_hscript_Token","pop",0xda60d7f9,"haxe.ds.GenericStack_hscript_Token.pop","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",130,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_144_isEmpty,"haxe.ds.GenericStack_hscript_Token","isEmpty",0x0c5cacab,"haxe.ds.GenericStack_hscript_Token.isEmpty","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",144,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_156_remove,"haxe.ds.GenericStack_hscript_Token","remove",0xac2392dc,"haxe.ds.GenericStack_hscript_Token.remove","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",156,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_178_iterator,"haxe.ds.GenericStack_hscript_Token","iterator",0x90d21686,"haxe.ds.GenericStack_hscript_Token.iterator","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",178,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_9b420934f1e4a6ff_203_toString,"haxe.ds.GenericStack_hscript_Token","toString",0x35a69d44,"haxe.ds.GenericStack_hscript_Token.toString","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",203,0x533c4adb)
namespace haxe{
namespace ds{

void GenericStack_hscript_Token_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_107_new)
            	}
...
void GenericStack_hscript_Token_obj::add( ::hscript::Token item){
            	HX_GC_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_113_add)
HXDLIN( 113)		this->_hx_set_head(HX_CTX,  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,this->head));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,add,(void))
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::first(){
            	HX_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_122_first)
...
bool GenericStack_hscript_Token_obj::isEmpty(){
            	HX_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_144_isEmpty)
...
bool GenericStack_hscript_Token_obj::remove( ::hscript::Token v){
            	HX_GC_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_156_remove)
...
HXLINE( 162)					this->_hx_set_head(HX_CTX, l->next);
            				}
            				else {
HXLINE( 164)					prev->_hx_set_next(HX_CTX, l->next);
            				}
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,remove,return )
 ...
 ::Dynamic GenericStack_hscript_Token_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_178_iterator)
...
::String GenericStack_hscript_Token_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_9b420934f1e4a6ff_203_toString)
...
hx::Val GenericStack_hscript_Token_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"head") ) { _hx_set_head(HX_CTX_GET,inValue.Cast<  ::haxe::ds::GenericCell_hscript_Token >()); return inValue; }
	}
