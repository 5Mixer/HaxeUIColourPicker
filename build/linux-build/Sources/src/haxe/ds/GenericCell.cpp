...
HX_DEFINE_STACK_FRAME(_hx_pos_dc7ed30cd1a64422_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",37,0x533c4adb)
namespace haxe{
namespace ds{
...
hx::Val GenericCell_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"elt") ) { _hx_set_elt(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::haxe::ds::GenericCell >()); return inValue; }
	}
