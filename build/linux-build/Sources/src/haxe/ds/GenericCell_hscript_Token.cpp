...
HX_DEFINE_STACK_FRAME(_hx_pos_d8e809e0ca5ac6cb_37_new,"haxe.ds.GenericCell_hscript_Token","new",0x1c0e2ea2,"haxe.ds.GenericCell_hscript_Token.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",37,0x533c4adb)
namespace haxe{
namespace ds{

void GenericCell_hscript_Token_obj::__construct( ::hscript::Token elt, ::haxe::ds::GenericCell_hscript_Token next){
            	HX_GC_STACKFRAME(&_hx_pos_d8e809e0ca5ac6cb_37_new)
HXLINE(  38)		this->_hx_set_elt(HX_CTX, elt);
HXLINE(  39)		this->_hx_set_next(HX_CTX, next);
            	}
...
hx::Val GenericCell_hscript_Token_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"elt") ) { _hx_set_elt(HX_CTX_GET,inValue.Cast<  ::hscript::Token >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::haxe::ds::GenericCell_hscript_Token >()); return inValue; }
	}
