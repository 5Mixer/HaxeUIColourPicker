...
HX_DEFINE_STACK_FRAME(_hx_pos_34ceeb5503b645c0_78_new,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","new",0xbf5d5a94,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",78,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_34ceeb5503b645c0_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","hasNext",0xccb359a1,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.hasNext","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",68,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_34ceeb5503b645c0_71_next,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","next",0xb251e83f,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.next","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",71,0x533c4adb)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_hscript_Token_obj::__construct( ::haxe::ds::GenericCell_hscript_Token head){
            	HX_GC_STACKFRAME(&_hx_pos_34ceeb5503b645c0_78_new)
HXDLIN(  78)		this->_hx_set_current(HX_CTX, head);
            	}
...
bool GenericStackIterator_hscript_Token_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_34ceeb5503b645c0_68_hasNext)
HXDLIN(  68)		return hx::IsNotNull( this->current );
            	}


 ::hscript::Token GenericStackIterator_hscript_Token_obj::next(){
            	HX_GC_STACKFRAME(&_hx_pos_34ceeb5503b645c0_71_next)
HXLINE(  72)		 ::hscript::Token result = this->current->elt;
HXLINE(  73)		this->_hx_set_current(HX_CTX, this->current->next);
...
hx::Val GenericStackIterator_hscript_Token_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"current") ) { _hx_set_current(HX_CTX_GET,inValue.Cast<  ::haxe::ds::GenericCell_hscript_Token >()); return inValue; }
	}
