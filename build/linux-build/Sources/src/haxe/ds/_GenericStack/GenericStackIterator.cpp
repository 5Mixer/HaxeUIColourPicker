...
HX_DEFINE_STACK_FRAME(_hx_pos_df48ba3884697ad3_78_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",78,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_df48ba3884697ad3_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",68,0x533c4adb)
HX_LOCAL_STACK_FRAME(_hx_pos_df48ba3884697ad3_71_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","/home/mixer/tools/Kha/Tools/haxe/std/haxe/ds/GenericStack.hx",71,0x533c4adb)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_GC_STACKFRAME(&_hx_pos_df48ba3884697ad3_78_new)
...
bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_df48ba3884697ad3_68_hasNext)
HXDLIN(  68)		return hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_GC_STACKFRAME(&_hx_pos_df48ba3884697ad3_71_next)
...
hx::Val GenericStackIterator_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"current") ) { _hx_set_current(HX_CTX_GET,inValue.Cast<  ::haxe::ds::GenericCell >()); return inValue; }
	}
