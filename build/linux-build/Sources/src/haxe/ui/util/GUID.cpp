...
HX_LOCAL_STACK_FRAME(_hx_pos_772ffb5154efc714_30_uuid,"haxe.ui.util.GUID","uuid",0xfa519a66,"haxe.ui.util.GUID.uuid","haxe/ui/util/GUID.hx",30,0xa433033a)
...
bool GUID_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x65ed6c8d;
}
...
HXLINE(   9)		::Array< ::String > characters = ::Array_obj< ::String >::fromData( _hx_array_data_89f7d023_3,62);
HXLINE(  13)		::Array< ::String > id = ::Array_obj< ::String >::__new(0);
HXLINE(  14)		if ((radix > 61)) {
HXLINE(  14)			radix = 61;
            		}
            		else {
HXLINE(  14)			radix = radix;
            		}
HXLINE(  16)		while(true){
HXLINE(  16)			length = (length - 1);
HXDLIN(  16)			if (!(((length + 1) > 0))) {
HXLINE(  16)				goto _hx_goto_1;
            			}
HXLINE(  17)			id->push(characters->__get(::Math_obj::floor((::Math_obj::random() * ( (Float)((1 + radix)) )))));
            		}
            		_hx_goto_1:;
HXLINE(  21)		{
HXLINE(  22)			 ::Dynamic x;
...
HXLINE(  27)		return id->join(HX_("",00,00,00,00));
            	}
...
::String GUID_obj::uuid(){
            	HX_STACKFRAME(&_hx_pos_772ffb5154efc714_30_uuid)
HXLINE(  31)		::Array< ::String > specialChars = ::Array_obj< ::String >::fromData( _hx_array_data_89f7d023_5,4);
HXLINE(  32)		::String _hx_tmp = (::haxe::ui::util::GUID_obj::createRandomIdentifier(8,15) + HX_("-",2d,00,00,00));
HXDLIN(  32)		::String _hx_tmp1 = ((_hx_tmp + ::haxe::ui::util::GUID_obj::createRandomIdentifier(4,15)) + HX_("-4",67,27,00,00));
HXDLIN(  32)		::String _hx_tmp2 = ((_hx_tmp1 + ::haxe::ui::util::GUID_obj::createRandomIdentifier(3,15)) + HX_("-",2d,00,00,00));
HXDLIN(  32)		::String _hx_tmp3 = (_hx_tmp2 + specialChars->__get(::Math_obj::floor((::Math_obj::random() * ( (Float)(4) )))));
HXDLIN(  32)		::String _hx_tmp4 = ((_hx_tmp3 + ::haxe::ui::util::GUID_obj::createRandomIdentifier(3,15)) + HX_("-",2d,00,00,00));
HXDLIN(  32)		return (_hx_tmp4 + ::haxe::ui::util::GUID_obj::createRandomIdentifier(12,15));
            	}
