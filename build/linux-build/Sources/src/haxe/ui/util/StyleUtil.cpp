...
HX_LOCAL_STACK_FRAME(_hx_pos_40fdcd83c070b6e2_13_styleProperty2ComponentProperty,"haxe.ui.util.StyleUtil","styleProperty2ComponentProperty",0x70b6ce31,"haxe.ui.util.StyleUtil.styleProperty2ComponentProperty","haxe/ui/util/StyleUtil.hx",13,0x90368666)
...
HX_LOCAL_STACK_FRAME(_hx_pos_40fdcd83c070b6e2_22_componentProperty2StyleProperty,"haxe.ui.util.StyleUtil","componentProperty2StyleProperty",0x70aa1131,"haxe.ui.util.StyleUtil.componentProperty2StyleProperty","haxe/ui/util/StyleUtil.hx",22,0x90368666)
...
HX_LOCAL_STACK_FRAME(_hx_pos_40fdcd83c070b6e2_6_boot,"haxe.ui.util.StyleUtil","boot",0x7020a3e7,"haxe.ui.util.StyleUtil.boot","haxe/ui/util/StyleUtil.hx",6,0x90368666)
namespace haxe{
namespace ui{
namespace util{
...
bool StyleUtil_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0146e9f7;
}
...
::String StyleUtil_obj::styleProperty2ComponentProperty(::String property){
            		...
            		::String _hx_run( ::EReg re){
            			HX_STACKFRAME(&_hx_pos_40fdcd83c070b6e2_13_styleProperty2ComponentProperty)
HXLINE(  13)			return re->matched(1).toUpperCase();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_40fdcd83c070b6e2_12_styleProperty2ComponentProperty)
HXDLIN(  12)		return ::haxe::ui::util::StyleUtil_obj::style2ComponentEReg->map(property, ::Dynamic(new _hx_Closure_0()));
            	}
...
::String StyleUtil_obj::componentProperty2StyleProperty(::String property){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		::String _hx_run( ::EReg re){
            			HX_STACKFRAME(&_hx_pos_40fdcd83c070b6e2_22_componentProperty2StyleProperty)
HXLINE(  22)			return (HX_("-",2d,00,00,00) + re->matched(1).toLowerCase());
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_40fdcd83c070b6e2_21_componentProperty2StyleProperty)
HXDLIN(  21)		return ::haxe::ui::util::StyleUtil_obj::component2StyleEReg->map(property, ::Dynamic(new _hx_Closure_0()));
            	}
...
HXDLIN(   5)		style2ComponentEReg =  ::EReg_obj::__alloc( HX_CTX ,HX_("-(\\w)",b3,da,be,03),HX_("g",67,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_40fdcd83c070b6e2_6_boot)
HXDLIN(   6)		component2StyleEReg =  ::EReg_obj::__alloc( HX_CTX ,HX_("([A-Z])",a7,4e,e3,6c),HX_("g",67,00,00,00));
            	}
}
