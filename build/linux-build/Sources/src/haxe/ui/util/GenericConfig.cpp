...
HXLINE(  11)		this->_hx_set_values(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  12)		this->_hx_set_sections(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            	}
...
HXLINE(  33)			return array->__get(0).StaticCast<  ::haxe::ui::util::GenericConfig >();
            		}
...
HXLINE(  39)							_hx_tmp1 = hx::IsEq( item->values->get(key1),value );
            						}
            						else {
...
HXLINE(  61)			return ::haxe::ui::util::GenericConfig_obj::cache->get_string(q);
            		}
...
HXDLIN(  70)				if ((f.indexOf(HX_("[",5b,00,00,00),null()) == -1)) {
HXLINE(  70)					_hx_tmp = (f.indexOf(HX_("@",40,00,00,00),null()) == -1);
            				}
            				else {
...
HXLINE(  72)					if ((f.indexOf(HX_("[",5b,00,00,00),null()) != -1)) {
HXLINE(  73)						::Array< ::String > p = f.split(HX_("[",5b,00,00,00));
HXLINE(  74)						::String p1 = p->__get(0);
HXLINE(  75)						::String p2 = p->__get(1).split(HX_("=",3d,00,00,00))->__get(0);
HXLINE(  76)						::String p3 = p->__get(1).split(HX_("=",3d,00,00,00))->__get(1);
HXLINE(  77)						p3 = p3.substr(0,(p3.length - 1));
HXLINE(  79)						ref = ref->findBy(p1,p2,p3);
            					}
            					else {
HXLINE(  80)						if ((f.indexOf(HX_("@",40,00,00,00),null()) != -1)) {
HXLINE(  81)							::String v = f.substr(1,f.length);
HXLINE(  82)							value = ref->values->get_string(v);
...
HXLINE(  94)			::String nq = (q.substring(0,(n + 1)) + HX_(".@condition",09,27,c9,36));
...
HXDLIN( 123)				if ((f.indexOf(HX_("[",5b,00,00,00),null()) == -1)) {
HXLINE( 123)					_hx_tmp = (f.indexOf(HX_("@",40,00,00,00),null()) == -1);
            				}
            				else {
...
HXLINE( 125)					if ((f.indexOf(HX_("[",5b,00,00,00),null()) != -1)) {
HXLINE( 126)						::Array< ::String > p = f.split(HX_("[",5b,00,00,00));
HXLINE( 127)						::String p1 = p->__get(0);
HXLINE( 128)						::String p2 = p->__get(1).split(HX_("=",3d,00,00,00))->__get(0);
HXLINE( 129)						::String p3 = p->__get(1).split(HX_("=",3d,00,00,00))->__get(1);
HXLINE( 130)						p3 = p3.substr(0,(p3.length - 1));
...
HXLINE( 142)			::String nq = (q.substring(0,(n + 1)) + HX_(".@condition",09,27,c9,36));
...
hx::Val GenericConfig_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"sections") ) { _hx_set_sections(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
