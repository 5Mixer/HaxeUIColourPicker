...
void ListenerInternal_obj::__construct( ::Dynamic callback,int priority){
            	HX_GC_STACKFRAME(&_hx_pos_19e42336dc92e684_30_new)
HXLINE(  31)		this->_hx_set_callback(HX_CTX, callback);
...
bool ListenerInternal_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x69f80ac4;
}
