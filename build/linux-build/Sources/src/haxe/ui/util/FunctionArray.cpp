...
void FunctionArray_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_5cdf254a4f2dae08_7_new)
HXDLIN(   7)		this->_hx_set__array(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FunctionArray_obj,contains,return )
 ...
 ::Dynamic FunctionArray_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_5cdf254a4f2dae08_71_iterator)
HXDLIN(  71)		return this->_array->iterator();
            	}
...
HXLINE(  76)		fa->_hx_set__array(HX_CTX, this->_array->copy());
HXLINE(  77)		return fa;
            	}
...
hx::Val FunctionArray_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_array") ) { _hx_set__array(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
