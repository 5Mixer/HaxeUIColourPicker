...
HX_DEFINE_STACK_FRAME(_hx_pos_fbe547e797c77141_165_new,"haxe.ui.components._TextField.TextBehaviour","new",0x4854ee28,"haxe.ui.components._TextField.TextBehaviour.new","haxe/ui/components/TextField.hx",165,0x9dfe9498)
HX_LOCAL_STACK_FRAME(_hx_pos_fbe547e797c77141_166_validateData,"haxe.ui.components._TextField.TextBehaviour","validateData",0x70043f18,"haxe.ui.components._TextField.TextBehaviour.validateData","haxe/ui/components/TextField.hx",166,0x9dfe9498)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_fbe547e797c77141_165_new)
HXDLIN( 165)		super::__construct(component);
            	}
...
bool TextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x207cf043) {
		if (inClassId<=(int)0x0c4fd8c6) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x0c4fd8c6;
		} else {
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_fbe547e797c77141_166_validateData)
HXLINE( 167)		 ::haxe::ui::components::TextField textfield = hx::TCast<  ::haxe::ui::components::TextField >::cast(this->_component);
HXLINE( 168)		::haxe::ui::components::_TextField::TextFieldHelper_obj::validateText(textfield,::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
HXLINE( 170)		bool _hx_tmp;
HXDLIN( 170)		if (hx::IsNotNull( this->_value )) {
HXLINE( 170)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 170)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::neq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
HXLINE( 170)			_hx_tmp = false;
            		}
HXDLIN( 170)		if (_hx_tmp) {
HXLINE( 171)			this->_hx_set__value(HX_CTX, ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(textfield->getTextInput()->get_text()));
            		}
            	}
