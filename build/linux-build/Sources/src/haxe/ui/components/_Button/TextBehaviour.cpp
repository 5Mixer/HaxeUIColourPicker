...
HX_DEFINE_STACK_FRAME(_hx_pos_4d84ef4d644c4db5_268_new,"haxe.ui.components._Button.TextBehaviour","new",0xe0f3d75f,"haxe.ui.components._Button.TextBehaviour.new","haxe/ui/components/Button.hx",268,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_4d84ef4d644c4db5_269_validateData,"haxe.ui.components._Button.TextBehaviour","validateData",0xeabff701,"haxe.ui.components._Button.TextBehaviour.validateData","haxe/ui/components/Button.hx",269,0x45086125)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_4d84ef4d644c4db5_268_new)
...
bool TextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x207cf043) {
		if (inClassId<=(int)0x0935ac93) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x0935ac93;
		} else {
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_4d84ef4d644c4db5_269_validateData)
HXLINE( 270)		 ::haxe::ui::components::Label label = this->_component->findComponent(null(),hx::ClassOf< ::haxe::ui::components::Label >(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE( 271)		if (hx::IsNull( label )) {
HXLINE( 272)			label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 273)			label->set_id(HX_("button-label",19,ae,e7,e0));
HXLINE( 274)			label->scriptAccess = false;
HXLINE( 275)			this->_component->addComponent(label);
HXLINE( 276)			{
HXLINE( 276)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 276)				_this->invalidateComponent(HX_("style",31,a5,1d,84));
HXDLIN( 276)				_this->_hx_set__style(HX_CTX, null());
            			}
            		}
HXLINE( 279)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
