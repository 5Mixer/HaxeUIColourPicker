...
HX_DEFINE_STACK_FRAME(_hx_pos_a7c69801980b3472_302_new,"haxe.ui.components._Button.ToggleBehaviour","new",0x04a58158,"haxe.ui.components._Button.ToggleBehaviour.new","haxe/ui/components/Button.hx",302,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_a7c69801980b3472_306_get,"haxe.ui.components._Button.ToggleBehaviour","get",0x04a0318e,"haxe.ui.components._Button.ToggleBehaviour.get","haxe/ui/components/Button.hx",306,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_a7c69801980b3472_309_set,"haxe.ui.components._Button.ToggleBehaviour","set",0x04a94c9a,"haxe.ui.components._Button.ToggleBehaviour.set","haxe/ui/components/Button.hx",309,0x45086125)
namespace haxe{
namespace ui{
...
void ToggleBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_a7c69801980b3472_302_new)
HXDLIN( 302)		super::__construct(component);
            	}
...
bool ToggleBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x6c6873cd) {
		...
		return inClassId==(int)0x788856ac;
	}
}

 ::haxe::ui::util::VariantType ToggleBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_a7c69801980b3472_306_get)
HXDLIN( 306)		return this->_value;
            	}


void ToggleBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_a7c69801980b3472_309_set)
HXLINE( 310)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(this->_value,value)) {
HXLINE( 311)			return;
            		}
HXLINE( 314)		this->_hx_set__value(HX_CTX, value);
HXLINE( 315)		 ::haxe::ui::components::Button button = hx::TCast<  ::haxe::ui::components::Button >::cast(this->_component);
HXLINE( 316)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
HXLINE( 317)			button->set_selected(false);
            		}
HXLINE( 319)		button->registerInternalEvents(button->_internalEventsClass,true);
            	}
