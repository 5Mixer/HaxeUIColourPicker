...
HX_DEFINE_STACK_FRAME(_hx_pos_fd90e646f9611825_207_new,"haxe.ui.components._Image.Builder","new",0x572d4a81,"haxe.ui.components._Image.Builder.new","haxe/ui/components/Image.hx",207,0xeed4974a)
HX_LOCAL_STACK_FRAME(_hx_pos_fd90e646f9611825_213_applyStyle,"haxe.ui.components._Image.Builder","applyStyle",0xbf999ce2,"haxe.ui.components._Image.Builder.applyStyle","haxe/ui/components/Image.hx",213,0xeed4974a)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Image image){
            	HX_GC_STACKFRAME(&_hx_pos_fd90e646f9611825_207_new)
HXLINE( 208)		super::__construct(image);
HXLINE( 209)		this->_hx_set__image(HX_CTX, image);
            	}
...
bool Builder_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2d78c66f) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x2d78c66f;
	} else {
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_fd90e646f9611825_213_applyStyle)
HXDLIN( 213)		if (hx::IsNotNull( style->resource )) {
HXLINE( 214)			 ::haxe::ui::components::Image _hx_tmp = this->_image;
HXDLIN( 214)			_hx_tmp->set_resource(::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(style->resource));
            		}
            	}
...
hx::Val Builder_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_image") ) { _hx_set__image(HX_CTX_GET,inValue.Cast<  ::haxe::ui::components::Image >()); return inValue; }
	}
