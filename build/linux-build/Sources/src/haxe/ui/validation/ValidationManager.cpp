...
void ValidationManager_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4cd6909a403eb58f_8_new)
HXLINE(  21)		this->_hx_set__displayQueue(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  20)		this->_hx_set__queue(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE(  31)			this->_hx_set__events(HX_CTX,  ::haxe::ui::util::EventMap_obj::__alloc( HX_CTX ));
            		}
...
void ValidationManager_obj::add(::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_4cd6909a403eb58f_54_add)
...
HXLINE(  87)			this->_queue->setCtx( HX_CTX, queueLength,object);
...
HXLINE( 132)				 ::haxe::ui::core::Component item1 = this->_displayQueue->__get(i).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 133)				item1->updateComponentDisplay();
            			}
            		}
...
hx::Val ValidationManager_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_queue") ) { _hx_set__queue(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_events") ) { _hx_set__events(HX_CTX_GET,inValue.Cast<  ::haxe::ui::util::EventMap >()); return inValue; }
		break;
	case 9:
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_displayQueue") ) { _hx_set__displayQueue(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
