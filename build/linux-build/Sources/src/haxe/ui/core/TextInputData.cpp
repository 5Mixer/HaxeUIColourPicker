...
HXLINE(  22)		this->_hx_set_onChangedCallback(HX_CTX, null());
HXLINE(  21)		this->_hx_set_onScrollCallback(HX_CTX, null());
HXLINE(  19)		this->vscrollNativeWheel = false;
HXLINE(  18)		this->_hx_set_vscrollPageStep(HX_CTX, null());
...
bool TextInputData_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x02f8aebe;
}
...
hx::Val TextInputData_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"vscrollPageStep") ) { _hx_set_vscrollPageStep(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"onScrollCallback") ) { _hx_set_onScrollCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"onChangedCallback") ) { _hx_set_onChangedCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 18:
