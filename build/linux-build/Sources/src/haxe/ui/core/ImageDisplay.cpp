...
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_108_isComponentInvalid,"haxe.ui.core.ImageDisplay","isComponentInvalid",0xbde5488e,"haxe.ui.core.ImageDisplay.isComponentInvalid","haxe/ui/core/ImageDisplay.hx",108,0x68d1df99)
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_125_invalidateComponent,"haxe.ui.core.ImageDisplay","invalidateComponent",0x6be417b8,"haxe.ui.core.ImageDisplay.invalidateComponent","haxe/ui/core/ImageDisplay.hx",125,0x68d1df99)
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_134_validateComponent,"haxe.ui.core.ImageDisplay","validateComponent",0xe8891bbd,"haxe.ui.core.ImageDisplay.validateComponent","haxe/ui/core/ImageDisplay.hx",134,0x68d1df99)
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_152_handleValidate,"haxe.ui.core.ImageDisplay","handleValidate",0x5ba51428,"haxe.ui.core.ImageDisplay.handleValidate","haxe/ui/core/ImageDisplay.hx",152,0x68d1df99)
namespace haxe{
namespace ui{
namespace core{
...
HXLINE(  12)		this->_hx_set__invalidationFlags(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
bool ImageDisplay_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2f4158f6) {
		...
		return inClassId==(int)0x460e4968 || inClassId==(int)0x65937de1;
	}
}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageDisplay_obj,get_imageInfo,return )
 ...
 ::Dynamic ImageDisplay_obj::set_imageInfo( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_5f2f5f31431489cc_82_set_imageInfo)
HXLINE(  83)		if (hx::IsEq( value,this->_imageInfo )) {
HXLINE(  84)			return value;
            		}
HXLINE(  87)		this->_hx_set__imageInfo(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(ImageDisplay_obj,get_imageClipRect,return )
 ...
 ::haxe::ui::geom::Rectangle ImageDisplay_obj::set_imageClipRect( ::haxe::ui::geom::Rectangle value){
            	HX_GC_STACKFRAME(&_hx_pos_5f2f5f31431489cc_100_set_imageClipRect)
HXLINE( 101)		this->_hx_set__imageClipRect(HX_CTX, value);
...
bool ImageDisplay_obj::isComponentInvalid(::String __o_flag){
            	...
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_108_isComponentInvalid)
HXLINE( 109)		if ((this->_isAllInvalid == true)) {
HXLINE( 110)			return true;
            		}
HXLINE( 113)		if ((flag == HX_("all",21,f9,49,00))) {
HXLINE( 114)			{
HXLINE( 114)				 ::Dynamic value = this->_invalidationFlags->iterator();
HXDLIN( 114)				while(( (bool)(value->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 114)					bool value1 = ( (bool)(value->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 115)					return true;
            				}
            			}
HXLINE( 118)			return false;
            		}
HXLINE( 121)		return this->_invalidationFlags->exists(flag);
            	}
...
void ImageDisplay_obj::invalidateComponent(::String __o_flag){
            		::String flag = __o_flag;
            		if (hx::IsNull(__o_flag)) flag = HX_("all",21,f9,49,00);
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_125_invalidateComponent)
HXDLIN( 125)		if ((flag == HX_("all",21,f9,49,00))) {
HXLINE( 126)			this->_isAllInvalid = true;
HXLINE( 127)			this->parentComponent->invalidateComponent(HX_("imageDisplay",27,a4,12,ab));
            		}
            		else {
HXLINE( 128)			if (!(this->_invalidationFlags->exists(flag))) {
HXLINE( 129)				this->_invalidationFlags->set(flag,true);
HXLINE( 130)				this->parentComponent->invalidateComponent(HX_("imageDisplay",27,a4,12,ab));
            			}
            		}
            	}
...
void ImageDisplay_obj::validateComponent(){
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_134_validateComponent)
HXLINE( 135)		bool _hx_tmp;
HXDLIN( 135)		if ((this->_isValidating != true)) {
HXLINE( 135)			_hx_tmp = (this->isComponentInvalid(null()) == false);
            		}
            		else {
...
HXLINE( 140)		this->_isValidating = true;
HXLINE( 142)		this->handleValidate();
HXLINE( 144)		{
HXLINE( 144)			 ::Dynamic flag = this->_invalidationFlags->keys();
HXDLIN( 144)			while(( (bool)(flag->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 144)				::String flag1 = ( (::String)(flag->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 145)				this->_invalidationFlags->remove(flag1);
            			}
            		}
HXLINE( 148)		this->_isAllInvalid = false;
HXLINE( 149)		this->_isValidating = false;
            	}
...
void ImageDisplay_obj::handleValidate(){
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_152_handleValidate)
HXLINE( 153)		bool dataInvalid = this->isComponentInvalid(HX_("data",2a,56,63,42));
HXLINE( 154)		bool positionInvalid = this->isComponentInvalid(HX_("position",a9,a0,fa,ca));
HXLINE( 155)		bool displayInvalid = this->isComponentInvalid(HX_("display",42,2a,4a,bb));
HXLINE( 157)		if (dataInvalid) {
HXLINE( 158)			this->validateData();
            		}
HXLINE( 161)		if (positionInvalid) {
HXLINE( 162)			this->validatePosition();
            		}
HXLINE( 165)		if (displayInvalid) {
HXLINE( 166)			this->validateDisplay();
            		}
            	}
