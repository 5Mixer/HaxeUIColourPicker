...
HX_DEFINE_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_126_new,"haxe.ui.core.ComponentValueBehaviour","new",0xf4e182fe,"haxe.ui.core.ComponentValueBehaviour.new","haxe/ui/core/ComponentContainer.hx",126,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_127_set,"haxe.ui.core.ComponentValueBehaviour","set",0xf4e54e40,"haxe.ui.core.ComponentValueBehaviour.set","haxe/ui/core/ComponentContainer.hx",127,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_137_get,"haxe.ui.core.ComponentValueBehaviour","get",0xf4dc3334,"haxe.ui.core.ComponentValueBehaviour.get","haxe/ui/core/ComponentContainer.hx",137,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_141_getDynamic,"haxe.ui.core.ComponentValueBehaviour","getDynamic",0x4d0622ab,"haxe.ui.core.ComponentValueBehaviour.getDynamic","haxe/ui/core/ComponentContainer.hx",141,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentValueBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_126_new)
...
void ComponentValueBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_127_set)
HXLINE( 128)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 129)			return;
            		}
HXLINE( 132)		this->_hx_set__value(HX_CTX, value);
HXLINE( 133)		 ::haxe::ui::core::Component _hx_tmp = this->_component;
HXDLIN( 133)		_hx_tmp->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value));
            	}


 ::haxe::ui::util::VariantType ComponentValueBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_137_get)
HXDLIN( 137)		return this->_value;
            	}


 ::Dynamic ComponentValueBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_141_getDynamic)
HXDLIN( 141)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toDynamic(this->_value);
            	}
