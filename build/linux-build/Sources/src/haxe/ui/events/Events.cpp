...
void Events_obj::__construct( ::haxe::ui::core::Component target){
            	HX_GC_STACKFRAME(&_hx_pos_b23cba198f770d4a_9_new)
HXDLIN(   9)		this->_hx_set__target(HX_CTX, target);
            	}
...
hx::Val Events_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_target") ) { _hx_set__target(HX_CTX_GET,inValue.Cast<  ::haxe::ui::core::Component >()); return inValue; }
	}
