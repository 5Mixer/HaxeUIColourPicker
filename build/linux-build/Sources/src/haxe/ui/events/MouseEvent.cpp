...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x4b74db99) {
		...
		return inClassId==(int)0x52331728 || inClassId==(int)0x5aa3ef0f;
	}
}
...
HXLINE(  48)		c->_hx_set_type(HX_CTX, this->type);
HXLINE(  49)		c->_hx_set_target(HX_CTX, this->target);
...
hx::Val MouseEvent_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"localX") ) { _hx_set_localX(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"localY") ) { _hx_set_localY(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 7:
