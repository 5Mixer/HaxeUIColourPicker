...
HX_DEFINE_STACK_FRAME(_hx_pos_65985b75449d76b8_15_new,"haxe.ui.filters.DropShadow","new",0x720927e6,"haxe.ui.filters.DropShadow.new","haxe/ui/filters/DropShadow.hx",15,0xd5f9af09)
namespace haxe{
namespace ui{
namespace filters{

void DropShadow_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65985b75449d76b8_15_new)
...
bool DropShadow_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x10378d50) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x10378d50;
	} else {
		return inClassId==(int)0x48067235;
	}
}
