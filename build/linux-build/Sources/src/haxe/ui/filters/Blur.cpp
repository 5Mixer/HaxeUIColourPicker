...
HX_DEFINE_STACK_FRAME(_hx_pos_74e540f925efc24d_7_new,"haxe.ui.filters.Blur","new",0x9686235e,"haxe.ui.filters.Blur.new","haxe/ui/filters/Blur.hx",7,0xfaa1a151)
namespace haxe{
namespace ui{
namespace filters{

void Blur_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_74e540f925efc24d_7_new)
...
bool Blur_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x07b80be4) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x07b80be4;
	} else {
