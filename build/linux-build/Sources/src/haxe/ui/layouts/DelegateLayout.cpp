...
void DelegateLayout_obj::__construct( ::haxe::ui::layouts::DelegateLayoutSize size){
            	HX_GC_STACKFRAME(&_hx_pos_630268b720cd3097_9_new)
HXLINE(  10)		super::__construct();
HXLINE(  11)		this->_hx_set__size(HX_CTX, size);
            	}
...
HXLINE(  15)		this->_size->_hx_set_component(HX_CTX, this->get_component());
...
HXLINE(  25)		return size;
 ...
 ::haxe::ui::geom::Size DelegateLayout_obj::get_usableSize(){
            	HX_GC_STACKFRAME(&_hx_pos_630268b720cd3097_28_get_usableSize)
HXLINE(  29)		 ::haxe::ui::geom::Size size = this->super::get_usableSize();
HXLINE(  30)		this->_size->_hx_set_component(HX_CTX, this->get_component());
...
hx::Val DelegateLayout_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_size") ) { _hx_set__size(HX_CTX_GET,inValue.Cast<  ::haxe::ui::layouts::DelegateLayoutSize >()); return inValue; }
	}
