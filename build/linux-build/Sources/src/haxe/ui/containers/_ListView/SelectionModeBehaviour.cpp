...
HX_DEFINE_STACK_FRAME(_hx_pos_65d0ca9efc541cc5_503_new,"haxe.ui.containers._ListView.SelectionModeBehaviour","new",0x4b924916,"haxe.ui.containers._ListView.SelectionModeBehaviour.new","haxe/ui/containers/ListView.hx",503,0xe137bf10)
HX_LOCAL_STACK_FRAME(_hx_pos_65d0ca9efc541cc5_504_validateData,"haxe.ui.containers._ListView.SelectionModeBehaviour","validateData",0x9087166a,"haxe.ui.containers._ListView.SelectionModeBehaviour.validateData","haxe/ui/containers/ListView.hx",504,0xe137bf10)
namespace haxe{
namespace ui{
...
void SelectionModeBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_65d0ca9efc541cc5_503_new)
HXDLIN( 503)		super::__construct(component);
            	}
...
bool SelectionModeBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3a374360) {
		...
		return inClassId==(int)0x6c6873cd || inClassId==(int)0x7bbed028;
	}
}

void SelectionModeBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_65d0ca9efc541cc5_504_validateData)
HXLINE( 505)		 ::haxe::ui::containers::ListView listView = hx::TCast<  ::haxe::ui::containers::ListView >::cast(this->_component);
HXLINE( 506)		::Array< int > selectedIndices = listView->get_selectedIndices();
HXLINE( 507)		if ((selectedIndices->length == 0)) {
HXLINE( 508)			return;
            		}
HXLINE( 511)		::String selectionMode = ( (::String)(this->_value) );
HXLINE( 512)		::String _hx_switch_0 = selectionMode;
            		if (  (_hx_switch_0==HX_("disabled",7c,41,04,7c)) ){
HXLINE( 514)			listView->set_selectedIndices(null());
HXDLIN( 514)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("one-item",9a,d3,eb,3b)) ){
HXLINE( 517)			if ((selectedIndices->length > 1)) {
HXLINE( 518)				listView->set_selectedIndices(::Array_obj< int >::__new(1)->init(0,selectedIndices->__get(0)));
            			}
HXLINE( 517)			goto _hx_goto_1;
            		}
            		/* default */{
            		}
            		_hx_goto_1:;
