...
HX_DEFINE_STACK_FRAME(_hx_pos_23063b15125c1daa_34_new,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour","new",0x42862caa,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour.new","haxe/ui/containers/menus/MenuOptionBox.hx",34,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_23063b15125c1daa_35_validateData,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour","validateData",0xd68c2056,"haxe.ui.containers.menus._MenuOptionBox.ShortcutTextBehaviour.validateData","haxe/ui/containers/menus/MenuOptionBox.hx",35,0x896244ad)
namespace haxe{
namespace ui{
...
void ShortcutTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_23063b15125c1daa_34_new)
...
bool ShortcutTextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3a374360) {
		...
		return inClassId==(int)0x69ee2e9a || inClassId==(int)0x6c6873cd;
	}
}

void ShortcutTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_23063b15125c1daa_35_validateData)
