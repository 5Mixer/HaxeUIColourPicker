...
HX_DEFINE_STACK_FRAME(_hx_pos_8171369b78303cea_19_new,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour","new",0xe1234fe2,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour.new","haxe/ui/containers/menus/MenuOptionBox.hx",19,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_8171369b78303cea_20_validateData,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour","validateData",0x3afcd61e,"haxe.ui.containers.menus._MenuOptionBox.GroupBehaviour.validateData","haxe/ui/containers/menus/MenuOptionBox.hx",20,0x896244ad)
namespace haxe{
namespace ui{
...
void GroupBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8171369b78303cea_19_new)
...
bool GroupBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x207cf043) {
		if (inClassId<=(int)0x105e617a) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x105e617a;
		} else {
...
void GroupBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_8171369b78303cea_20_validateData)
HXLINE(  21)		 ::haxe::ui::components::OptionBox optionbox = this->_component->findComponent(null(),hx::ClassOf< ::haxe::ui::components::OptionBox >(),false,null()).StaticCast<  ::haxe::ui::components::OptionBox >();
HXLINE(  22)		if (hx::IsNull( optionbox )) {
HXLINE(  23)			optionbox =  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX );
HXLINE(  24)			optionbox->set_styleNames(HX_("menuitem-optionbox",9b,0c,7d,bf));
HXLINE(  25)			optionbox->scriptAccess = false;
HXLINE(  26)			this->_component->addComponent(optionbox);
            		}
HXLINE(  29)		optionbox->set_componentGroup(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
