...
HX_DEFINE_STACK_FRAME(_hx_pos_7d84d5d166e74123_78_new,"haxe.ui.containers.menus._MenuOptionBox.Builder","new",0x7f4ee25b,"haxe.ui.containers.menus._MenuOptionBox.Builder.new","haxe/ui/containers/menus/MenuOptionBox.hx",78,0x896244ad)
HX_LOCAL_STACK_FRAME(_hx_pos_7d84d5d166e74123_81_create,"haxe.ui.containers.menus._MenuOptionBox.Builder","create",0x2e7d83e1,"haxe.ui.containers.menus._MenuOptionBox.Builder.create","haxe/ui/containers/menus/MenuOptionBox.hx",81,0x896244ad)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_7d84d5d166e74123_78_new)
...
bool Builder_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x052e411f) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x052e411f;
	} else {
...
void Builder_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_7d84d5d166e74123_81_create)
HXLINE(  82)		this->_hx_set__optionbox(HX_CTX,  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX ));
HXLINE(  83)		this->_optionbox->set_styleNames(HX_("menuitem-optionbox",9b,0c,7d,bf));
HXLINE(  84)		this->_optionbox->scriptAccess = false;
HXLINE(  85)		this->_component->addComponent(this->_optionbox);
HXLINE(  87)		 ::haxe::ui::components::Label label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE(  88)		label->set_id(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE(  89)		label->set_styleNames(HX_("menuitem-shortcut-label",a8,00,78,8b));
HXLINE(  90)		label->scriptAccess = false;
HXLINE(  91)		this->_component->addComponent(label);
            	}
...
hx::Val Builder_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"_optionbox") ) { _hx_set__optionbox(HX_CTX_GET,inValue.Cast<  ::haxe::ui::components::OptionBox >()); return inValue; }
	}
