...
HX_DEFINE_STACK_FRAME(_hx_pos_73e3f42abe9d2281_206_new,"haxe.ui.containers._ScrollView.HScrollPos","new",0x407b4e98,"haxe.ui.containers._ScrollView.HScrollPos.new","haxe/ui/containers/ScrollView.hx",206,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_211_get,"haxe.ui.containers._ScrollView.HScrollPos","get",0x4075fece,"haxe.ui.containers._ScrollView.HScrollPos.get","haxe/ui/containers/ScrollView.hx",211,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_219_validateData,"haxe.ui.containers._ScrollView.HScrollPos","validateData",0x50a650a8,"haxe.ui.containers._ScrollView.HScrollPos.validateData","haxe/ui/containers/ScrollView.hx",219,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPos_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_GC_STACKFRAME(&_hx_pos_73e3f42abe9d2281_206_new)
HXLINE( 207)		super::__construct(scrollview);
HXLINE( 208)		this->_hx_set__scrollview(HX_CTX, scrollview);
            	}
...
bool HScrollPos_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x207cf043) {
		if (inClassId<=(int)0x0de2f380) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x0de2f380;
		} else {
 ...
 ::haxe::ui::util::VariantType HScrollPos_obj::get(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_211_get)
HXLINE( 212)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 213)		if (hx::IsNull( hscroll )) {
HXLINE( 214)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(0) ));
            		}
HXLINE( 216)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(hscroll->get_pos());
            	}


void HScrollPos_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_219_validateData)
HXLINE( 220)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 221)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 222)			if (hx::IsNull( hscroll )) {
HXLINE( 223)				hscroll = hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 225)			if (hx::IsNotNull( hscroll )) {
HXLINE( 226)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            		else {
HXLINE( 229)			if (hx::IsNotNull( hscroll )) {
HXLINE( 230)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
