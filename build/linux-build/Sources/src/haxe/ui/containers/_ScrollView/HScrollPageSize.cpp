...
HX_DEFINE_STACK_FRAME(_hx_pos_b4b8756cce4b494c_348_new,"haxe.ui.containers._ScrollView.HScrollPageSize","new",0x1788fc50,"haxe.ui.containers._ScrollView.HScrollPageSize.new","haxe/ui/containers/ScrollView.hx",348,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_b4b8756cce4b494c_354_validateData,"haxe.ui.containers._ScrollView.HScrollPageSize","validateData",0x38812bf0,"haxe.ui.containers._ScrollView.HScrollPageSize.validateData","haxe/ui/containers/ScrollView.hx",354,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPageSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_GC_STACKFRAME(&_hx_pos_b4b8756cce4b494c_348_new)
HXLINE( 349)		super::__construct(scrollview);
HXLINE( 350)		this->_hx_set__scrollview(HX_CTX, scrollview);
            	}
...
bool HScrollPageSize_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3a374360) {
		...
		return inClassId==(int)0x57d6e6a8 || inClassId==(int)0x6c6873cd;
	}
}

void HScrollPageSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_b4b8756cce4b494c_354_validateData)
HXDLIN( 354)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 355)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 356)			if (hx::IsNull( hscroll )) {
HXLINE( 357)				hscroll = hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 359)			if (hx::IsNotNull( hscroll )) {
HXLINE( 360)				hscroll->set_pageSize(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
