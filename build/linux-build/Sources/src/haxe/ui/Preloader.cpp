...
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_315_registerBehaviours,"haxe.ui.Preloader","registerBehaviours",0x45539f03,"haxe.ui.Preloader.registerBehaviours","haxe/ui/macros/Macros.hx",315,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_7d3e1c8290b31e6a_521_cloneComponent,"haxe.ui.Preloader","cloneComponent",0x4a1983ca,"haxe.ui.Preloader.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",521,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_302_self,"haxe.ui.Preloader","self",0xcd8cad36,"haxe.ui.Preloader.self","haxe/ui/macros/Macros.hx",302,0x27866361)
namespace haxe{
namespace ui{
	...
	if (inClassId<=(int)0x4eb0678b) {
		...
		if (inClassId<=(int)0x7f63f3f1) {
			if (inClassId<=(int)0x7ee2d869) {
				return inClassId==(int)0x7140e8dc || inClassId==(int)0x7ee2d869;
			} else {
				return inClassId==(int)0x7f63f3f1;
			}
		} else {
			return inClassId==(int)0x7fba9fc4 || inClassId==(int)0x7ff0cb0e;
		}
	}
}
...
HXDLIN(  27)		if (hx::IsGreater( this->get_width(),0 )) {
HXLINE(  27)			_hx_tmp = hx::IsGreater( this->get_height(),0 );
            		}
            		else {
HXLINE(  27)			_hx_tmp = false;
            		}
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  28)			Float _hx_tmp1 = (::haxe::ui::core::Screen_obj::get_instance()->get_width() / ( (Float)(2) ));
HXDLIN(  28)			this->set_left((_hx_tmp1 - (( (Float)(this->get_width()) ) / ( (Float)(2) ))));
HXLINE(  29)			Float _hx_tmp2 = (::haxe::ui::core::Screen_obj::get_instance()->get_height() / ( (Float)(2) ));
HXDLIN(  29)			this->set_top((_hx_tmp2 - (( (Float)(this->get_height()) ) / ( (Float)(2) ))));
            		}
HXLINE(  31)		return b;
            	}
...
void Preloader_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_3272413211a8f5fe_315_registerBehaviours)
HXDLIN( 315)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Preloader_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_7d3e1c8290b31e6a_521_cloneComponent)
HXLINE( 267)		 ::haxe::ui::Preloader c = ( ( ::haxe::ui::Preloader)(this->super::cloneComponent()) );
...
HXLINE( 293)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Preloader_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3272413211a8f5fe_302_self)
HXDLIN( 302)		return  ::haxe::ui::Preloader_obj::__alloc( HX_CTX );
            	}
