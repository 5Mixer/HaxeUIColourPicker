...
bool LayoutBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3a374360) {
		if (inClassId<=(int)0x344410df) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x344410df;
		} else {
...
void LayoutBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_0525753a45c1d9a0_7_set)
HXLINE(   8)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE(   9)			return;
            		}
HXLINE(  12)		this->_hx_set__value(HX_CTX, value);
HXLINE(  13)		{
