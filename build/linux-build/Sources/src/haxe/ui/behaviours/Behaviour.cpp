...
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_30_detatch,"haxe.ui.behaviours.Behaviour","detatch",0x93543d94,"haxe.ui.behaviours.Behaviour.detatch","haxe/ui/behaviours/Behaviour.hx",30,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_38_get,"haxe.ui.behaviours.Behaviour","get",0xdf5127ff,"haxe.ui.behaviours.Behaviour.get","haxe/ui/behaviours/Behaviour.hx",38,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_42_getDynamic,"haxe.ui.behaviours.Behaviour","getDynamic",0xc8d82d40,"haxe.ui.behaviours.Behaviour.getDynamic","haxe/ui/behaviours/Behaviour.hx",42,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_48_update,"haxe.ui.behaviours.Behaviour","update",0x1d4ca640,"haxe.ui.behaviours.Behaviour.update","haxe/ui/behaviours/Behaviour.hx",48,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_56_call,"haxe.ui.behaviours.Behaviour","call",0x8509ed15,"haxe.ui.behaviours.Behaviour.call","haxe/ui/behaviours/Behaviour.hx",56,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_62_getConfigValue,"haxe.ui.behaviours.Behaviour","getConfigValue",0x61fadb90,"haxe.ui.behaviours.Behaviour.getConfigValue","haxe/ui/behaviours/Behaviour.hx",62,0x4ca16ea8)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa3e5c84c3b760_75_getConfigValueBool,"haxe.ui.behaviours.Behaviour","getConfigValueBool",0xbdac93da,"haxe.ui.behaviours.Behaviour.getConfigValueBool","haxe/ui/behaviours/Behaviour.hx",75,0x4ca16ea8)
namespace haxe{
namespace ui{
namespace behaviours{

void Behaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_GC_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_10_new)
HXLINE(  11)		this->_hx_set_config(HX_CTX, null());
HXLINE(  17)		this->_hx_set__component(HX_CTX, component);
            	}
...
void Behaviour_obj::detatch(){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_30_detatch)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Behaviour_obj,detatch,(void))
 ...
 ::haxe::ui::util::VariantType Behaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_38_get)
...
HX_DEFINE_DYNAMIC_FUNC0(Behaviour_obj,get,return )
 ...
 ::Dynamic Behaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_42_getDynamic)
...
void Behaviour_obj::update(){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_48_update)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Behaviour_obj,update,(void))
 ...
 ::haxe::ui::util::VariantType Behaviour_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_56_call)
...
::String Behaviour_obj::getConfigValue(::String name,::String defaultValue){
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_62_getConfigValue)
HXLINE(  63)		if (hx::IsNull( this->config )) {
HXLINE(  64)			return defaultValue;
            		}
HXLINE(  66)		if ((this->config->exists(name) == false)) {
HXLINE(  67)			return defaultValue;
            		}
HXLINE(  69)		return this->config->get_string(name);
            	}
...
bool Behaviour_obj::getConfigValueBool(::String name,hx::Null< bool >  __o_defaultValue){
            	...
            	HX_STACKFRAME(&_hx_pos_e9aa3e5c84c3b760_75_getConfigValueBool)
HXLINE(  76)		bool v = defaultValue;
HXLINE(  77)		::String s = this->getConfigValue(name,null());
HXLINE(  78)		if (hx::IsNotNull( s )) {
HXLINE(  79)			v = (s == HX_("true",4e,a7,03,4d));
            		}
HXLINE(  81)		return v;
            	}
...
hx::Val Behaviour_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"config") ) { _hx_set_config(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 10:
