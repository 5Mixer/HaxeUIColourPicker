...
HX_DEFINE_STACK_FRAME(_hx_pos_ba418526ce7b3618_7_new,"haxe.ui.backend.CallLaterImpl","new",0xecae2eb4,"haxe.ui.backend.CallLaterImpl.new","haxe/ui/backend/CallLaterImpl.hx",7,0xcf690bdd)
namespace haxe{
namespace ui{
namespace backend{

void CallLaterImpl_obj::__construct( ::Dynamic fn){
            	HX_STACKFRAME(&_hx_pos_ba418526ce7b3618_7_new)
HXDLIN(   7)		::kha::Scheduler_obj::addTimeTask(fn,((Float)0.001),null(),null());
            	}
...
bool CallLaterImpl_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5c5173f8;
}
