...
HX_DEFINE_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_8_new,"haxe.ui.backend.AppBase","new",0x7f013bf8,"haxe.ui.backend.AppBase.new","haxe/ui/backend/AppBase.hx",8,0xff9a3459)
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_10_registerEvent,"haxe.ui.backend.AppBase","registerEvent",0x5efe644f,"haxe.ui.backend.AppBase.registerEvent","haxe/ui/backend/AppBase.hx",10,0xff9a3459)
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_17_hasEvent,"haxe.ui.backend.AppBase","hasEvent",0x262a9fc8,"haxe.ui.backend.AppBase.hasEvent","haxe/ui/backend/AppBase.hx",17,0xff9a3459)
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_25_unregisterEvent,"haxe.ui.backend.AppBase","unregisterEvent",0x5593d056,"haxe.ui.backend.AppBase.unregisterEvent","haxe/ui/backend/AppBase.hx",25,0xff9a3459)
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_31_dispatch,"haxe.ui.backend.AppBase","dispatch",0x42715c22,"haxe.ui.backend.AppBase.dispatch","haxe/ui/backend/AppBase.hx",31,0xff9a3459)
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_36_build,"haxe.ui.backend.AppBase","build",0x507c5cc6,"haxe.ui.backend.AppBase.build","haxe/ui/backend/AppBase.hx",36,0xff9a3459)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7f106e4dd2e029f6_44_getToolkitInit,"haxe.ui.backend.AppBase","getToolkitInit",0x9f945560,"haxe.ui.backend.AppBase.getToolkitInit","haxe/ui/backend/AppBase.hx",44,0xff9a3459)
...
void AppBase_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_8_new)
HXDLIN(   8)		this->_hx_set__hx___events(HX_CTX, null());
            	}
...
void AppBase_obj::registerEvent(::String type, ::Dynamic listener,hx::Null< int >  __o_priority){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_10_registerEvent)
HXLINE(  11)		if (hx::IsNull( this->_hx___events )) {
HXLINE(  12)			this->_hx_set__hx___events(HX_CTX,  ::haxe::ui::util::EventMap_obj::__alloc( HX_CTX ));
            		}
HXLINE(  14)		this->_hx___events->add(type,listener,priority);
            	}
...
bool AppBase_obj::hasEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_17_hasEvent)
HXLINE(  18)		if (hx::IsNull( this->_hx___events )) {
HXLINE(  19)			return false;
            		}
HXLINE(  21)		return this->_hx___events->contains(type,listener);
            	}
...
void AppBase_obj::unregisterEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_25_unregisterEvent)
HXDLIN(  25)		if (hx::IsNotNull( this->_hx___events )) {
HXLINE(  26)			this->_hx___events->remove(type,listener);
            		}
            	}
...
void AppBase_obj::dispatch( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_31_dispatch)
HXDLIN(  31)		if (hx::IsNotNull( this->_hx___events )) {
HXLINE(  32)			this->_hx___events->invoke(event->type,event,null());
            		}
            	}
...
void AppBase_obj::build(){
            	HX_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_36_build)
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(AppBase_obj,init,(void))
 ...
 ::Dynamic AppBase_obj::getToolkitInit(){
            	HX_STACKFRAME(&_hx_pos_7f106e4dd2e029f6_44_getToolkitInit)
HXDLIN(  44)		return  ::Dynamic(hx::Anon_obj::Create(0));
            	}
