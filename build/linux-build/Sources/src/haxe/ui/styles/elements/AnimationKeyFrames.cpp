...
void AnimationKeyFrames_obj::__construct(::String id,::Array< ::Dynamic> keyframes){
            	HX_GC_STACKFRAME(&_hx_pos_757b3a2f53629a8c_3_new)
HXLINE(   6)		this->_hx_set__keyframes(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(   9)		this->_hx_set_id(HX_CTX, id);
HXLINE(  10)		this->_hx_set__keyframes(HX_CTX, keyframes);
            	}
...
bool AnimationKeyFrames_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x76034f3c;
}
...
hx::Val AnimationKeyFrames_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"keyFrames") ) { _hx_set_keyFrames(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
