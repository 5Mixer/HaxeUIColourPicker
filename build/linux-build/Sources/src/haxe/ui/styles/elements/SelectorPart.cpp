...
HX_LOCAL_STACK_FRAME(_hx_pos_3568bda1d302e2c1_16_get_classNameParts,"haxe.ui.styles.elements.SelectorPart","get_classNameParts",0x3fc6bb25,"haxe.ui.styles.elements.SelectorPart.get_classNameParts","haxe/ui/styles/elements/SelectorPart.hx",16,0x091ea96f)
...
void SelectorPart_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_3568bda1d302e2c1_3_new)
HXLINE(  14)		this->_hx_set__parts(HX_CTX, null());
HXLINE(   9)		this->_hx_set_nodeName(HX_CTX, null());
HXLINE(   8)		this->_hx_set_id(HX_CTX, null());
HXLINE(   7)		this->_hx_set_className(HX_CTX, null());
HXLINE(   6)		this->_hx_set_pseudoClass(HX_CTX, null());
HXLINE(   4)		this->_hx_set_parent(HX_CTX, null());
            	}
...
bool SelectorPart_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2bdbc0ad;
}

::Array< ::String > SelectorPart_obj::get_classNameParts(){
            	HX_GC_STACKFRAME(&_hx_pos_3568bda1d302e2c1_16_get_classNameParts)
HXLINE(  17)		if (hx::IsNull( this->className )) {
HXLINE(  18)			return null();
            		}
HXLINE(  20)		if (hx::IsNull( this->_parts )) {
HXLINE(  21)			this->_hx_set__parts(HX_CTX, this->className.split(HX_(".",2e,00,00,00)));
            		}
HXLINE(  23)		return this->_parts;
            	}
...
HXLINE(  31)				sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            			}
            			else {
...
HXLINE(  34)				sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            			}
            			else {
...
HXLINE(  37)				sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            			}
            			else {
...
HXLINE(  40)				sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            			}
            			else {
...
hx::Val SelectorPart_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::haxe::ui::styles::elements::SelectorPart >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_parts") ) { _hx_set__parts(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"pseudoClass") ) { _hx_set_pseudoClass(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"classNameParts") ) { _hx_set_classNameParts(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	}
