...
void MediaQuery_obj::__construct(::Array< ::Dynamic> directives, ::haxe::ui::styles::StyleSheet styleSheet){
            	HX_GC_STACKFRAME(&_hx_pos_e0ff9bf0438fb4d4_6_new)
HXLINE(   7)		this->_hx_set__directives(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  11)		this->_hx_set__directives(HX_CTX, directives);
HXLINE(  12)		this->_hx_set__styleSheet(HX_CTX, styleSheet);
            	}
...
bool MediaQuery_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2dd2d1f7;
}
...
hx::Val MediaQuery_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"styleSheet") ) { _hx_set_styleSheet(HX_CTX_GET,inValue.Cast<  ::haxe::ui::styles::StyleSheet >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_directives") ) { _hx_set__directives(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_styleSheet") ) { _hx_set__styleSheet(HX_CTX_GET,inValue.Cast<  ::haxe::ui::styles::StyleSheet >()); return inValue; }
	}
