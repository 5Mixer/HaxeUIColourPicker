...
HXLINE(  10)		this->_hx_set_target(HX_CTX, target);
HXLINE(  11)		this->_hx_set_propertyName(HX_CTX, propertyName);
...
bool PropertyDetails_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4b12638f;
}
