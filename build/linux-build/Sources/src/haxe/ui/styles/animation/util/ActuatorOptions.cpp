...
HX_DEFINE_STACK_FRAME(_hx_pos_28943a1499ce47e8_11_new,"haxe.ui.styles.animation.util.ActuatorOptions","new",0x7f42982f,"haxe.ui.styles.animation.util.ActuatorOptions.new","haxe/ui/styles/animation/util/Actuator.hx",11,0xdc64e2fe)
namespace haxe{
namespace ui{
namespace styles{
namespace animation{
...
void ActuatorOptions_obj::__construct( ::Dynamic delay, ::haxe::ui::styles::EasingFunction easingFunction, ::Dynamic onComplete, ::Dynamic onUpdate){
            	HX_GC_STACKFRAME(&_hx_pos_28943a1499ce47e8_11_new)
HXDLIN(  11)		this->_hx_set_delay(HX_CTX, delay);
HXDLIN(  11)		this->_hx_set_easingFunction(HX_CTX, easingFunction);
HXDLIN(  11)		this->_hx_set_onComplete(HX_CTX, onComplete);
HXDLIN(  11)		this->_hx_set_onUpdate(HX_CTX, onUpdate);
            	}
...
bool ActuatorOptions_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7d123d9b;
}
