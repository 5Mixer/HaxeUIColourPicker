...
HXLINE(  15)		this->_hx_set_target(HX_CTX, target);
HXLINE(  16)		this->_hx_set_propertyName(HX_CTX, propertyName);
...
bool ColorPropertyDetails_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1d6e3c94;
}
...
hx::Val ColorPropertyDetails_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"propertyName") ) { _hx_set_propertyName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
