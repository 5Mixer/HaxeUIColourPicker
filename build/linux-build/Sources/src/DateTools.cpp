...
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_45___format_get,"DateTools","__format_get",0xabb90f8f,"DateTools.__format_get","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",45,0xd879804c)
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_110___format,"DateTools","__format",0x77c4edf8,"DateTools.__format","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",110,0xd879804c)
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_155_format,"DateTools","format",0x1113a898,"DateTools.format","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",155,0xd879804c)
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_35_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",35,0xd879804c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_36_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",36,0xd879804c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_37_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",37,0xd879804c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_be556322d138afa0_40_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/mixer/tools/Kha/Tools/haxe/std/DateTools.hx",40,0xd879804c)
...
::String DateTools_obj::_hx___format_get( ::Date d,::String e){
            	HX_STACKFRAME(&_hx_pos_be556322d138afa0_45___format_get)
...
::String DateTools_obj::_hx___format( ::Date d,::String f){
            	HX_GC_STACKFRAME(&_hx_pos_be556322d138afa0_110___format)
...
HXLINE( 118)					r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len)));
            				}
            				else {
...
HXLINE( 119)					r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            				}
            				else {
...
HXLINE( 123)				r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len1)));
            			}
            			else {
...
::String DateTools_obj::format( ::Date d,::String f){
            	HX_STACKFRAME(&_hx_pos_be556322d138afa0_155_format)
