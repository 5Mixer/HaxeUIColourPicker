...
HX_DEFINE_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_28_new,"EReg","new",0x8b859e81,"EReg.new","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",28,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_36_match,"EReg","match",0x18fda1a6,"EReg.match","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",36,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",45,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",62,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",65,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_74_split,"EReg","split",0x9749433b,"EReg.split","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",74,0x41563aeb)
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",98,0x41563aeb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4d0c2f3eb0edd437_149_map,"EReg","map",0x8b84d8bd,"EReg.map","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/EReg.hx",149,0x41563aeb)

void EReg_obj::__construct(::String r,::String opt){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_28_new)
...
bool EReg_obj::match(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_45_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,hx::Null< int >  __o_len){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_98_replace)
...
HXLINE( 124)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_10,1));
            							}
            							else {
...
HXLINE( 131)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_11,1));
            							}
            							else {
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_4d0c2f3eb0edd437_149_map)
