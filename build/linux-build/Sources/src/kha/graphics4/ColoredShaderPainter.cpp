...
HXDLIN( 414)					int i1 = (_g1 - 1);
HXLINE( 415)					triIndices->self.set((i1 * 3),(i1 * 3));
HXLINE( 416)					triIndices->self.set(((i1 * 3) + 1),((i1 * 3) + 1));
HXLINE( 417)					triIndices->self.set(((i1 * 3) + 2),((i1 * 3) + 2));
            				}
            			}
