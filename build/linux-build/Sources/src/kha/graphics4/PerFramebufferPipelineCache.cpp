...
HXLINE(  95)				textureLocation = pipeline->getTextureUnit(HX_("tex",e7,5d,58,00));
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic x1 = _hx_e;
HXLINE(  98)					::haxe::Log_obj::trace(x1,hx::SourceInfo(HX_("kha/graphics4/Graphics2.hx",08,e8,1d,0c),98,HX_("kha.graphics4.PerFramebufferPipelineCache",c1,21,3d,dd),HX_("new",60,d0,53,00)));
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
...
bool PerFramebufferPipelineCache_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2514d407;
}
