...
HX_DEFINE_STACK_FRAME(_hx_pos_e11396c11bd16cc9_82_new,"sys.ssl._Socket.SocketOutput","new",0xc0bfe785,"sys.ssl._Socket.SocketOutput.new","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/sys/ssl/Socket.hx",82,0x0f11dba2)
HX_LOCAL_STACK_FRAME(_hx_pos_e11396c11bd16cc9_85_writeByte,"sys.ssl._Socket.SocketOutput","writeByte",0x9388946c,"sys.ssl._Socket.SocketOutput.writeByte","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/sys/ssl/Socket.hx",85,0x0f11dba2)
HX_LOCAL_STACK_FRAME(_hx_pos_e11396c11bd16cc9_100_writeBytes,"sys.ssl._Socket.SocketOutput","writeBytes",0x83f94a87,"sys.ssl._Socket.SocketOutput.writeBytes","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/sys/ssl/Socket.hx",100,0x0f11dba2)
HX_LOCAL_STACK_FRAME(_hx_pos_e11396c11bd16cc9_111_close,"sys.ssl._Socket.SocketOutput","close",0x0d5f021d,"sys.ssl._Socket.SocketOutput.close","/home/mixer/tools/Kha/Tools/haxe/std/cpp/_std/sys/ssl/Socket.hx",111,0x0f11dba2)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketOutput_obj::__construct( ::sys::ssl::Socket s){
            	HX_GC_STACKFRAME(&_hx_pos_e11396c11bd16cc9_82_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_e11396c11bd16cc9_85_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_e11396c11bd16cc9_100_writeBytes)
HXDLIN( 100)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_e11396c11bd16cc9_111_close)
