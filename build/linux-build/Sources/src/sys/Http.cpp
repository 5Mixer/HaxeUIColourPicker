...
HX_DEFINE_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_48_new,"sys.Http","new",0xa5e0041b,"sys.Http.new","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",48,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_60_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",60,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_56_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",56,0x84069dd9)
static const bool _hx_array_data_00b75aa9_3[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_90_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",90,0x84069dd9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_209_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",209,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_255_writeBody,"sys.Http","writeBody",0xc731a11c,"sys.Http.writeBody","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",255,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_280_readHttpResponse,"sys.Http","readHttpResponse",0xd67be204,"sys.Http.readHttpResponse","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",280,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_422_readChunk,"sys.Http","readChunk",0x940c4532,"sys.Http.readChunk","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",422,0x84069dd9)
HX_LOCAL_STACK_FRAME(_hx_pos_64f48cfb2146eb2e_46_boot,"sys.Http","boot",0x763c9417,"sys.Http.boot","/home/mixer/tools/Kha/Tools/haxe/std/sys/Http.hx",46,0x84069dd9)
namespace sys{

void Http_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_48_new)
...
void Http_obj::request( ::Dynamic post){
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_60_request)
HXLINE(  61)			_gthis->_hx_set_responseBytes(HX_CTX, output->getBytes());
HXLINE(  62)			err[0] = true;
HXLINE(  64)			_gthis->_hx_set_onError(HX_CTX, old);
HXLINE(  65)			_gthis->onError(e);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_56_request)
...
HXLINE(  60)		this->_hx_set_onError(HX_CTX,  ::Dynamic(new _hx_Closure_0(err,_gthis,output,old)));
...
void Http_obj::customRequest(bool post, ::haxe::io::Output api, ::sys::net::Socket sock,::String method){
            	HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_90_customRequest)
HXLINE(  91)		this->_hx_set_responseAsString(HX_CTX, null());
HXLINE(  92)		this->_hx_set_responseBytes(HX_CTX, null());
...
HXLINE( 143)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_9,1));
            						}
            						else {
...
HXLINE( 144)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(boundary)));
            						}
            						else {
...
HXLINE( 145)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_10,1));
            						}
            						else {
...
HXLINE( 146)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_11,1));
            						}
            						else {
...
HXLINE( 147)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 148)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_12,1));
            						}
            						else {
...
HXLINE( 149)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_13,1));
            						}
            						else {
...
HXLINE( 150)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_14,1));
            						}
            						else {
...
HXLINE( 151)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            						}
            						else {
...
HXLINE( 152)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_15,1));
            						}
            						else {
...
HXLINE( 154)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_16,1));
            				}
            				else {
...
HXLINE( 155)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(boundary)));
            				}
            				else {
...
HXLINE( 156)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_17,1));
            				}
            				else {
...
HXLINE( 157)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_18,1));
            				}
            				else {
...
HXLINE( 158)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            				}
            				else {
...
HXLINE( 159)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_19,1));
            				}
            				else {
...
HXLINE( 160)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            				}
            				else {
...
HXLINE( 161)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_20,1));
            				}
            				else {
...
HXLINE( 162)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_21,1));
            				}
            				else {
...
HXLINE( 163)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            				}
            				else {
...
HXLINE( 203)			this->_hx_set_postBytes(HX_CTX, ::haxe::io::Bytes_obj::ofString(this->postData,null()));
HXLINE( 204)			this->_hx_set_postData(HX_CTX, null());
            		}
...
HXDLIN( 209)				if (!(multipart)) {
            					...
            					bool _hx_run( ::Dynamic h){
            						HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_209_customRequest)
...
void Http_obj::writeBody( ::haxe::io::BytesOutput body, ::haxe::io::Input fileInput,int fileSize,::String boundary, ::sys::net::Socket sock){
            	HX_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_255_writeBody)
...
void Http_obj::readHttpResponse( ::haxe::io::Output api, ::sys::net::Socket sock){
            	HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_280_readHttpResponse)
...
HXLINE( 357)		this->_hx_set_responseHeaders(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
HXLINE( 377)		this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 378)		this->_hx_set_chunk_buf(HX_CTX, null());
...
bool Http_obj::readChunk( ::EReg chunk_re, ::haxe::io::Output api, ::haxe::io::Bytes buf,int len){
            	HX_GC_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_422_readChunk)
...
HXLINE( 430)				this->_hx_set_chunk_buf(HX_CTX, null());
            			}
...
HXLINE( 440)					this->_hx_set_chunk_size(HX_CTX, ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + cstr)));
HXLINE( 441)					if (hx::IsEq( this->chunk_size,0 )) {
HXLINE( 442)						this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 443)						this->_hx_set_chunk_buf(HX_CTX, null());
...
HXLINE( 455)			this->_hx_set_chunk_buf(HX_CTX, buf->sub(0,len));
HXLINE( 456)			return true;
            		}
HXLINE( 459)		if (hx::IsGreater( this->chunk_size,len )) {
HXLINE( 460)			 ::sys::Http _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 460)			_hx_tmp1->_hx_set_chunk_size(HX_CTX, (_hx_tmp1->chunk_size - len));
...
HXLINE( 469)			this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 470)			if ((len == 0)) {
...
HXDLIN( 476)		_hx_tmp2->_hx_set_chunk_size(HX_CTX, (_hx_tmp2->chunk_size - len));
...
{
{
            	HX_STACKFRAME(&_hx_pos_64f48cfb2146eb2e_46_boot)
